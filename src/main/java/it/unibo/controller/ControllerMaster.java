...
//holaaaa, metti a null le view quando inizializzi i controller intanto
    public ControllerMaster(ModelMaster modelMaster) {
        ...
        this.cannonController = new CannonController(modelMaster.getCannonModel(), modelMaster.getKeyboardModel(),this.progressBarController);
        this.bulletController = new BulletController(modelMaster.getBulletModel(), modelMaster.getGrid(), modelMaster.getKeyboardModel(), this.progressBarController, null, new Scale());
